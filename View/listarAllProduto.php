    ...
    <body>
        <div class="container">
                ...
                <div class="card bg-dark text-white text-center font-weight-bold">
                    <div class="card-body">
                        Lista de Produtos
                        <a href="formCadastrarProduto.php" target="centro" class="btn btn-light btn-sm float-right"
                           data-toggle='tooltip' data-placement='left' title='Cadastrar novo produto!'>
